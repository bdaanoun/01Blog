...
public class GlobalExceptionHandler {
    ...
    //catches "You cannot ban yourself" 
    ...
    // If you throw ErrorResponseException sometimes 
    ...
    public ResponseEntity<ApiError> methodNotAllowed(HttpRequestMethodNotSupportedException ex, HttpServletRequest req) {
        return build(HttpStatus.METHOD_NOT_ALLOWED, "Method not allowed for this endpoint.", req);
    }
